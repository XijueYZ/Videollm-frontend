...
import { Send, Bot, User, Paperclip, X, Image, Video } from 'lucide-react'
...
const Chat = (props: { collapseSettings: boolean, setCollapseSettings: (collapseSettings: boolean) => void }) => {
    const { collapseSettings, setCollapseSettings } = props
    ...
    return (
        <div style={{ height: 'calc(100% - 29px)' }} className="flex flex-row">
            ...
            <div className={`transition-all duration-300 ease-in-out ${
                collapseSettings ? 'w-0' : 'w-[300px] border-l-1'
            }`}>
                                ...
                                <div className="flex flex-col space-y-1.5">
                                    ...
                                    <div className="flex items-center justify-between space-x-2">
                                        ...
                                        <Input
                                            ...
                                            max="1"
                                            step="0.01"
                                            className="w-[50px] p-[6px] text-center text-xs [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none [-moz-appearance:textfield]"
                                        />
                                    </div>
                                </div>
                            </div>
